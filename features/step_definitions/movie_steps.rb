...
Then /I should see "(.*)" before "(.*)"/ do |e1, e2|
  ...
  expect(page.body.match(/#{e1}.+#{e2}/m)).to_not be_nil
end
...
# Make it easier to express seeing several movies
#   "Then I should see the following movies: a, b, c"
Then /I should see the following movies: (.*)/ do |movies|
  movies.split(',').each do |movie|
    step "I should see \"#{movie.strip}\""
  end
end
